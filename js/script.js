...
(function projects() {
  ...
  const data = [
    ...
    { tag: 'In Progress · Week 2 / 8', title: 'GIKI-SkyLabs AI Bootcamp', desc: 'An 8-week intensive going from the math of modern AI to deploying autonomous agents — currently in Week 2, with daily logs worked in the open.', long: 'An 8-week journey from first principles to production agents: Weeks 1–2 build the mathematical foundations (linear algebra, calculus, probability, information theory, convex optimization) behind attention and training; Weeks 3–4 cover NLP and transformer architectures (self-attention, BERT, GPT) with hands-on fine-tuning, pretraining, and scaling laws; Week 5 goes into post-training and alignment (instruction tuning, RLHF/RLAIF, PEFT, and Chain/Tree/Graph-of-Thought reasoning); Week 6 covers agentic AI (ReAct, tool-using agents, memory, multi-agent orchestration) and advanced RAG; Week 7 is inference and deployment (ML/LLMOps — versioning, CI/CD, serving, observability, cost and security); and Week 8 is a capstone building and deploying an autonomous agent system. I\'m currently in Week 2, shipping and documenting progress as I go.', stack: ['Python', 'Transformers', 'RLHF', 'Agentic AI', 'LLMOps'], link: 'https://github.com/Sajid0875/agentic-systems-bootcamp' },
  ];
  data.forEach((d, i) => {
